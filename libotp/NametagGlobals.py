...
_whisper_colors = [
    [
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.2, 0.6, 0.8, 0.6)),
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.2, 0.7, 0.9, 0.6)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.2, 0.7, 0.8, 0.6))
    ],
    [
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.2, 0.6, 0.8, 0.6)),
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
    ...
    [
        ...
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.8, 0.4, 1.0, 0.6)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.8, 0.3, 0.6, 0.6))
    ],
    [
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.8, 0.3, 0.6, 0.6)),
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.8, 0.4, 0.0, 0.8)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.8, 0.3, 0.6, 0.6))
    ],
    [
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.9, 0.5, 0.1, 0.6)),
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.9, 0.6, 0.2, 0.6)),
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.9, 0.6, 0.1, 0.6))
    ],
    [
        (Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.9, 0.5, 0.1, 0.6)),
        (Vec4(1.0, 0.5, 0.5, 1.0), Vec4(1.0, 1.0, 1.0, 0.8)),
